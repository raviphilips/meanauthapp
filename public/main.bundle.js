...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMessagesService.show('Please fill the Valid Email!', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        // Register User
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('Your now registered and can log in!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
...
module.exports = "<div class=\"jumbotron\">\n\t<h1>MEAN Authentication App</h1>\n\t<p class=\"lead\">Welcome to our custom MEAN authentication application built from scratch</p>\n\t<div>\n\t\t<a class=\"btn btn-priamry\" [routerLink]=\"['/register']\">Register</a>\n\t\t<a class=\"btn btn-default\" [routerLink]=\"['/login']\">Login</a>\n\t</div>\n</div>\n\n<div class=\"row\">\n\t<div class=\"col-md-4\">\n\t\t<h3>Express Backend</h3>\n\t\t<p>A rock solid Node.js/Express server</p>\n\t</div>\n\t<div class=\"col-md-4\">\n\t\t<h3>Angular-Cli</h3>\n\t\t<p>A rock solid Node.js/Express server</p>\n\t</div>\n\t<div class=\"col-md-4\">\n\t\t<h3>JWT-Token</h3>\n\t\t<p>A rock solid Node.js/Express server</p>\n\t</div>\n</div>\n"
...
var AuthService = (function () {
    ...
    AuthService.prototype.loggedIn = function () {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_angular2_jwt__["tokenNotExpired"])('id_token'); //missing 'id_token' due to this unable to view profile and dashboard pages
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_home_home_component__ = __webpack_require__(99);
